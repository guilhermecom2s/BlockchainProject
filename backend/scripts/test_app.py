...
time.sleep(1) #to guarantee that they happen in the order they are supposed to
post_wallet_transact_2 = post_wallet_transact(recipient, 13)
print(f'\npost_wallet_transact_2: {post_wallet_transact_2}')
#these transaction takes some time as it needs to conect to the network and make requests....

time.sleep(1) #I'll wait so the transactions above can atually appear in the transaction pool
