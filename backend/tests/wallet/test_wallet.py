...
def test_verify_invalid_signature():
    ...
    assert not Wallet.verify(Wallet().public_key, data, signature) #Passing a random public key 
...
def test_calculate_balance():
    ...
    received_transaction_2 = Transaction(
        ...
        received_amount_2 #amount
    ) #the sender wallet will be different by the recipient is the same
